<template>
    <div>
        ...
        <div class="country-td-con">
            <table id="exampleaa" class="table table-bordered display dt-responsive  nowrap" style="width:100%">
                <thead>
                    <th>Statutory document name</th>
                    <th>Statutory file</th>
                </thead>
                <tbody>
                    <tr>
                        <td>
                            <input class="form-control" type="text" placeholder="Enter statutory document name">
                        </td>
                        <td>
                            <input class="form-control" type="text" placeholder="Enter statutory file">
                        </td>
                    </tr>
                </tbody>
            </table>
