   ...
   <center >
      ...
      <form class="" @submit.prevent="sendData">
       <div class="form-con-items">
        ...
        <label><h4>Sections</h4></label>
        <div class="input wrapper flex items-center" 
          v-for="(input, index) in gender"
        ...
        >
         ...
         <b-icon icon="dash-circle-fill" 
          v-show="gender.length > 1"  
          @click="removeField(index, gender)" 
          font-scale="1.5"
          variant="warning"
          >
          </b-icon>
      ...
      <div class="input-plus">
         <div></div>
         <div>
           <b-button @click="addField(input, gender)" variant="primary" >
